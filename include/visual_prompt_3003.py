...
However, short well-known literal terms (roughly 4-6 characters, e.g. app or service
names) have a much higher chance of rendering correctly than free-form sentences or
multi-item lists. If the narration mentions a specific short app name, product name, or
service name, you may include that exact literal word as a label in the image_prompt
(e.g., a phone screen labeled with the app's name). Do NOT invent or write out longer
text such as full menus, multiple UI labels, sentences, or paragraphs of on-screen text;
